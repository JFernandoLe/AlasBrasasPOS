    <?php 
        ...
        $db=conectarDB();
        $consultaCategoria="SELECT * FROM productos WHERE id_producto=$id;";
        ...
        if($_SERVER['REQUEST_METHOD']==='POST'){
            ...
            if(empty($errores)){
                ...
                unlink($carpetaImagenes.$producto['imagen'].".webp");
                ...
                $query="UPDATE productos SET nombre='$nombre', activo='$activo', categoria='$categoria', detalles='$detalles', precio='$precio', imagen='$nombreImagen', stock='$stock'  WHERE id_producto=$id ;";
        ...
        <section class="contenedor formulario--seccion">
            ...
            <form class="formulario" method="POST" enctype="multipart/form-data">
                <fieldset class="formulario--fieldset">
                    <legend class="formulario--titulo">Modificar</legend>
                    ...
                    <div class="formulario--campo">
                        ...
                        <img src="<?= BASE_URL ?>/imagenes/<?php echo$imagenProducto.".webp"?>" class="imagen-small">
                    </div>
                    <div class="formulario--campo">
